 ...
 */
@TableName("tuifangjiesuan")
public class TuifangjiesuanEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public TuifangjiesuanEntity() {
		
	}
	
	public TuifangjiesuanEntity(T t) {
		try {
	...
	private Integer zhufangshizhang;
	 ...
	 * 设置：住房时长
	 */
	public void setZhufangshizhang(Integer zhufangshizhang) {
		this.zhufangshizhang = zhufangshizhang;
	}
	/**
	 * 获取：住房时长
	 */
	public Integer getZhufangshizhang() {
		return zhufangshizhang;
	}
	/**
	 * 设置：预订间数
	 */
	public void setYudingjianshu(Integer yudingjianshu) {
		this.yudingjianshu = yudingjianshu;
	}
	/**
	 * 获取：预订间数
	 */
	 ...
	 * 设置：支付金额
	 */
	public void setZhifujine(Double zhifujine) {
